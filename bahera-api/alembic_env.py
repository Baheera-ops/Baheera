...
"""
Alembic env.py — async migration runner for BAHERA.

Setup:
  1. pip install alembic
  2. alembic init alembic
  3. Replace alembic/env.py with this file
  4. Set sqlalchemy.url in alembic.ini OR let this script read from .env
